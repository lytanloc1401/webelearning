			...
			<?php
                    ...
                    <ul class="responsive-table">
                        <li class="table-header">
                            <div class="col col-1">ExerciseID</div>
                            <div class="col col-4">Filesubmit</div>
                            <div class="col col-2">Action</div>
                        </li>
				<?php
                            
                            $ex= $_GET['subID'];
                            $course = $db->query("SELECT ExerciseID, Filesubmit from tblsubmits where ExerciseID='$ex' ");
                            foreach ($course as $item) {
                              ...
                              // echo "</pre>";?><li class="table-row">
                                ...
                                <div class="col col-4" ><?php echo $item['Filesubmit'];?></div>
                                <div class="col col-4" ><?php echo '<a href="'.'fileSubmit'.$item['Filesubmit'].'" class="btn btn-xs btn-info" download><i class="fa fa-download"></i> Download</a>'; ?></div>
