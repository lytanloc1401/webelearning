	...
	<div class="table-responsive">
		<table id="example" class="table table-bordered">
            ...
            <?php
                ...
                <div class="container">
                    <ul class="responsive-table">
                        <li class="table-header">
                            ...
                            <div class="col col-4">Exercise</div>
                ...
                <?php
                $Subid= $_GET["subID"];
                $course = $db->query("SELECT SubjectID, ExerciseID , LessonID,TEXT, ExercisesDate from tblexercise where SubjectID='$Subid'");
                foreach ($course as $item) {
                    ...
                    <li class="table-row">
                                ...
                                <div class="col col-4" ><?php echo $item['LessonID'];  ?></div>
                                <div class="col col-5" ><?php echo $item['TEXT'];  ?></div>
                                <div class="col col-2" ><?php echo $item['ExercisesDate'];  ?></div>
                                <div class="col col-2" ><a href="FormSubmit.php?subID=<?php echo $item['ExerciseID'];?>">Submit</a></div>
                              </li>
                <?php  }?>	</ul>
			</thead>
