				...
				<div class="container">
                    <ul class="responsive-table">
                        ...
                        /**         
                            ...
                            $sql1 = "SELECT SubjectID FROM tblsubstu WHERE StudentID  = '$Stuid' ";
                            ...
                            foreach ($course as $item) {
                              ...
                              <li class="table-row">
                                ...
                                <div class="col col-2" ><a href="FormComment.php?subID=<?php echo $_GET['subID'];?>&LesID=<?php echo $item['LessonID']; ?>">View</a></div>
                              </li>
            <?php  }?> </ul>		  	
			</thead>
		</table>
